...
> * *Workflow outputs include*: custom graph of cloud costs, AI summary of news/sport, local weather warnings, local flood status as a custom graph, email notifications for new software versions and infrequently updated rss feeds, auto backup n8n workflows to github.  Refer [Sample daily report](https://n8n-daily-report.rossarn.workers.dev/).
> 
> ### Why?
