...
<div class="project-card is-live">
  <div class="project-card-image">
    <img src="./newschart-consensus.png" alt="Screenshot from NewsChart: consensus map view showing top international news stories plotted by model" data-lightbox-group="newschart">
  </div>
  <div class="project-card-body">
    <div class="project-card-header">
      <h2>NewsChart</h2>
...
<div class="project-card">
  <div class="project-card-image">
    <img src="./n8n-canvas.png" alt="Screenshot from n8n workflows: workflow canvas showing connected automation nodes" data-lightbox-group="n8n">
  </div>
  <div class="project-card-body">
    <div class="project-card-header">
      <h2>n8n workflows</h2>
    ...
    <p class="project-status">Internal · Workflow automation on GCP</p>
    <p class="project-description">Self-hosted n8n instance running scheduled data aggregation, reporting, and backup workflows on GCP infrastructure managed with Terraform.</p>
  </div>
  <img src="./n8n-aggregation.png" alt="Screenshot from n8n workflows: data aggregation workflow with conditional logic" data-lightbox-group="n8n" hidden>
  <img src="./n8n-reporting.png" alt="Screenshot from n8n workflows: reporting output graph" data-lightbox-group="n8n" hidden>
</div>
