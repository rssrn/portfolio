...
> 
> ## Why?
> Sharpen my AI-assisted development skills.  Used [Claude Code](https://claude.ai/ ), closely directed to cover feature definition, architecture, QA, usability, accessibility, responsiveness.
> 
> ## Tech
> * FFmpeg for general processing of input clips
> * Discards empty sections of input clips using YOLOv8 with pre-trained COCO dataset.
...
> 
> See [birdbird credits](https://birdbird.rossarn.workers.dev/credits) for further details.
