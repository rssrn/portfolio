---
title: NewsChart
description: Asks several leading AI models daily for the top three international news stories, then plots them on a world map so you can compare editorial judgement across models.
---
> [!aside-left]
...
>### What?
> See it in action at [NewsChart](https://newschart.rossarnold.uk/).  Each day it asks several leading AI models (Gemini, Perplexity, ChatGPT, Claude, xAI Grok) the same question - "what are today's top three international news stories?" - and plots their answers on a world map.  Switch between models to see which stories each chose, where they think the action is, and how their editorial judgements compare against each other and a New York Times baseline.  A date timeline lets you look back at how stories broke and where models agreed or diverged.
> 
> ### Why?
